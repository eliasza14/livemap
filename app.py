...
def main():
    ...
    url2="https://github.com/A-PALIOS/livemap_backend/blob/main/testgeo2.geojson"
    ...
    geodf = geopandas.read_file('./data/geojson1.geojson')
    geodf2 = geopandas.read_file('./data/geojson2.geojson')
